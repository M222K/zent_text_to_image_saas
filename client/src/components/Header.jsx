...
if(user){
    //if user present navigate to genrate page else login
    navigate('/result')
}else{
    setshowLogin(true);
}
    ...
    return (
        // slowly increase the delay in components 
        <motion.div className='flex flex-col justify-center items-center text-center my-20'
            ...
            <motion.button className='sm:text-lg text-white bg-black w-auto mt-8 px-12 py-2.5 flex items-centergap-2 rounded-full'
            ...
            {/* //display the images of sample in home page */}
            ...
            <motion.p className='mt-2 text-neutral-600'
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ dealy: 1.2, duration: 0.8 }}>Generated images from zent.ai</motion.p>
